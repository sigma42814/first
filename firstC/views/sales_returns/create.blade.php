...
<div class="container-fluid px-4">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white py-2">
            <h5 class="mb-0">
                <i class="fas fa-undo me-2"></i> Create Sales Return
            </h5>
        </div>
        <div class="card-body p-3">
            ...
            <div class="row invoice-info mb-3">
                ...
                <div class="col-md-1 position-relative">
                    ...
                    <input type="text" id="customerCode" class="form-control form-control-sm" placeholder="Search..." 
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" id="customerName" class="form-control form-control-sm" readonly>
                ...
                <div class="col-md-1">
                    ...
                    <input type="text" id="returnNumber" class="form-control form-control-sm" placeholder="Auto" readonly>
                </div>
...
<script>
    ...
    async function saveReturn() {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error(data.message || 'Failed to save sales return');
            }
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Failed to save sales return: ' + error.message
            });
        } finally {
            isSaving = false;
            if (saveButton) {
