<form id="addItemForm" action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-6 mb-2">
            ...
            <input type="number" step="0.01" class="form-control form-control-sm" id="item_purchase_price" name="item_purchase_price" required>
        ...
        <div class="col-md-6 mb-2">
            ...
            <input type="number" step="0.01" class="form-control form-control-sm" id="mrp" name="mrp" required>
            @error('mrp')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="row">
        <div class="col-md-6 mb-2">
            ...
            <input type="number" step="0.01" class="form-control form-control-sm" id="tp" name="tp" required>
            @error('tp')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="col-md-6 mb-2">
            ...
            <input type="number" class="form-control form-control-sm" id="low_quantity" name="low_quantity" required>
            @error('low_quantity')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="mb-2">
        ...
        <img id="photo_preview" src="#" alt="Product Photo" class="img-thumbnail mt-2" style="max-width: 100px; display: none;">
        @error('product_photo')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
